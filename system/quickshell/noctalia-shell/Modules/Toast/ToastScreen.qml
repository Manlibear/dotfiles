...
Item {
  ...
  Connections {
    ...
    function onNotify(title, description, icon, type, duration, actionLabel, actionCallback, image) {
      root.enqueueToast({
                          "title": title,
  ...
  Loader {
    ...
    onStatusChanged: {
      ...
      if (status === Loader.Ready && pendingToast !== null) {
        item.showToast(pendingToast.title, pendingToast.description, pendingToast.icon, pendingToast.type, pendingToast.duration, pendingToast.actionLabel, pendingToast.actionCallback, pendingToast.image);
        pendingToast = null;
      }
    }
    ...
    sourceComponent: PanelWindow {
      ...
      function showToast(title, description, icon, type, duration, actionLabel, actionCallback, image) {
        toastItem.show(title, description, icon, type, duration, actionLabel, actionCallback, image);
      }
