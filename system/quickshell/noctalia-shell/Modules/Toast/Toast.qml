...
Item {
  ...
  RowLayout {
    ...
    // Icon: real app image/avatar when available, otherwise the type glyph
    NImageRounded {
      readonly property int boxSize: isCompact ? Math.round(28 * Style.uiScaleRatio) : Math.round(44 * Style.uiScaleRatio)
      ...
      fallbackIconSize: isCompact ? Style.fontSizeXL : Style.fontSizeXXL * 1.5
    }
  ...
  function show(msgTitle, msgDescription, msgIcon, msgType, msgDuration, msgActionLabel, msgActionCallback, msgImage) {
